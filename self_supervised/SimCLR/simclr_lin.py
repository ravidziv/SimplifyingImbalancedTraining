...
def finetune(args: DictConfig) -> None:
    ...
    train_set = IMBALANCECIFAR10(root=data_dir,
                            train=True,
    ...
    test_set = IMBALANCECIFAR10(root=data_dir,
                                 train=False,
                                 transform=train_transform,
                                 download=True,
                                 imb_type=args.imb_type, imb_factor=1,
                                 rand_number=1,
                                 )
    ...
    pre_model.load_state_dict(torch.load('/scratch/rs8020/data/ssl/simclrexp_0.01_clr_resnet34_1000_epoch.pt'))
