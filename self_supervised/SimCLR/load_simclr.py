...
class CIFAR10Pair(IMBALANCECIFAR10):
...
def train(args: DictConfig) -> None:
    ...
    for epoch in range(1, args.epochs + 1):
        ...
        if epoch >= args.log_interval and epoch % args.log_interval == 0:
            ...
            torch.save(model.state_dict(), '/scratch/rs8020/data/ssl/simclr{}_{}_{}_{}_{}_epoch.pt'.format(args.imb_type, args.imb_factor, args.name,
                                                                                                           args.backbone, epoch))
